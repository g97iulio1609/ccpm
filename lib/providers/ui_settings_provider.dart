...
final uiGlassEnabledProvider =
    StateNotifierProvider<UiGlassEnabledNotifier, bool>((ref) {
...
final appBarGlassAllRoutesProvider =
    StateNotifierProvider<UiAppBarGlassScopeNotifier, bool>((ref) {
      final prefs = ref.read(prefsForThemeProvider);

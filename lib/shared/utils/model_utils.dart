...
class WorkoutUtils {
  ...
  static Workout duplicateWorkout(
    ...
    return workout.copyWith(
      ...
      exercises: workout.exercises
          .map((e) => ExerciseUtils.duplicateExercise(e))
          .toList(),
    );
  }
  ...
  static double calculateWorkoutVolume(Workout workout) {
    return workout.exercises.fold(
      0.0,
      (total, exercise) => total + ExerciseUtils.calculateVolume(exercise),
    );
  }
  ...
  static Map<String, dynamic> getWorkoutSummary(Workout workout) {
    final totalSeries = workout.exercises.fold(
      0,
...
class WeekUtils {
  ...
  static Week duplicateWeek(Week week, {String? newId, int? newNumber}) {
    return week.copyWith(
      ...
      workouts: week.workouts
          .map((w) => WorkoutUtils.duplicateWorkout(w))
          .toList(),
    );
  }
  ...
  static double calculateWeekVolume(Week week) {
    return week.workouts.fold(
      0.0,
      (total, workout) => total + WorkoutUtils.calculateWorkoutVolume(workout),
    );
  }
  ...
  static Map<String, dynamic> getWeekSummary(Week week) {
    final totalExercises = week.workouts.fold(
      0,

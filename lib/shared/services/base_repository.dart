        ...
        switch (operation.type) {
          case BatchOperationType.create:
            if (operation.id != null) {
              batch.set(collection.doc(operation.id), toFirestore(operation.model!));
            } else {
              batch.set(collection.doc(), toFirestore(operation.model!));
            }
            break;
          case BatchOperationType.update:
            batch.update(collection.doc(operation.id!), toFirestore(operation.model!));
            break;

    ...
    body: loading
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final superSetExercises = superSetId != null
                  ? getExercisesForSuperSet(superSetId)
                  : [exercise];
              final superSetIndex = superSetId != null
                  ? superSetExercises.indexWhere(
                      (e) => e['id'] == exercise['id'])
                  : null;
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                if (superSetId != null)
                                  Text(
                                    'Super Set Esercizio ${superSetExercises.length > 1 ? "${superSetIndex! + 1} - " : ""}${exercise['name']} ${exercise['variant'] ?? ''}',

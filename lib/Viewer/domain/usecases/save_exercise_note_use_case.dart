...
class SaveExerciseNoteParams {
  ...
  SaveExerciseNoteParams({required this.workoutId, required this.exerciseId, required this.note});
}
...
class SaveExerciseNoteUseCaseImpl implements SaveExerciseNoteUseCase {
  ...
  Future<void> call(SaveExerciseNoteParams params) async {
    ...
    if (params.note.trim().isEmpty) {
      ...
      return await _workoutRepository.deleteNoteForExercise(params.workoutId, params.exerciseId);
    }
    await _workoutRepository.saveNoteForExercise(params.workoutId, params.exerciseId, params.note);
  }
}

...
final exerciseCacheProvider = StateProvider<Map<String, List<Map<String, dynamic>>>>((ref) => {});
...
final trainingProgramServicesProvider = Provider<TrainingProgramServices>((ref) {
